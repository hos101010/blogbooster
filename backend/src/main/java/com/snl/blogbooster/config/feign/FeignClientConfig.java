...
//    }
    ...
    @Bean
    public Client feignClient(ApacheHttpClientFactory httpClientFactory, HttpClientConnectionManager httpClientConnectionManager, FeignHttpClientProperties httpClientProperties) {

        RequestConfig defualtRequestConfig = RequestConfig.custom()
        ...
        HttpClientBuilder httpClientBuilder = httpClientFactory.createBuilder()
                ...
                .setDefaultRequestConfig(defualtRequestConfig)
